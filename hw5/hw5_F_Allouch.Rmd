...
## Question 1 (d)
$\text{Pr(UTI = 1)} = \frac{e^{\beta_0 + (\beta_1 \times 50) + (\beta_2 * 0) + (\beta_3 \times 0) + (\beta_4 \times 0)}}{1 + e^{\beta_0 + (\beta_1 \times 50) + (\beta_2 * 0) + (\beta_3 \times 0) + (\beta_4 \times 0)}} = \frac{e^{0.4469 + (-0.0171 \times 50) + 0 + 0 + 0}}{1 + e^{0.4469 + (-0.0171 \times 50) + 0 + 0 + 0}} = 0.399$
...
$\text{OR} = \frac{e^{(\beta_0 + (\beta_1 \times 50) + (\beta_2 \times 0) + (\beta_3 \times 0) + (\beta_4 \times 0))}}{e^{(\beta_0 + (\beta_1 \times 55) + (\beta_2 \times 1) + (\beta_3 \times 1) + (\beta_4 \times 0))}} = \frac{e^{(0.4469 + (-0.0171 \times 50) + (-0.2081 \times 0) + (-0.2385 \times 0) + (-0.0222 \times 0))}}{0.4469 + (e^{(-0.0171 \times 55) + (-0.2081 \times 1) + (-0.2385 \times 1) + (-0.0222 \times 0))}} = 1.7$
