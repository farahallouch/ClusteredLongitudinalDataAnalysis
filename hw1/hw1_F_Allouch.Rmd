...
## Question 4 (b)
```{r}
independent_lm <- lm(PHQ ~ Treatment + time,
                     data = dat_long)
...
I spoke to Dr. Tang and wasn't able to complete this question in R. This is from the Linear Mixed-Effects Models Using R book in the subtext of the figure that Dr. Tang had in his lectures: "We do not present the syntax for constructing the figure, as it is fairly complex."