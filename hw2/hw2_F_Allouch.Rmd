...
```{r}
# Multivariate ANOVA
multivariate_anova <- manova(cbind(math, physics, chemistry) ~ as.numeric(student), # doesn't work with as.factor(student)
                             data = dat)
...
# Question 2 
## Question 2 (a)
$$Y_{ij} = \mu + \mu_j + \epsilon_{ij}, \epsilon_i \sim N(0, \Sigma)$$

where no assumptions assumed for $\Sigma$ since the repeated measures are treated as different variables.
